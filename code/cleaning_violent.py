...
remove_list = {"Case number", "Primary Type", "FBI Code", "Description", "Arrest", "Domestic", "Year", "Location", "X Coordinate", "Y Coordinate", "Latitude", "Longitude"}
...
cleaning("../data/Crimes_-_2005.csv", remove_list, "../data/2005_violent_cleaned.csv", index_iucr, violent_index_iucr, all_iucr)